...
static void
cl_feature_dependencies_2_test_register_callbacks(sr_session_ctx_t *session, sr_subscription_ctx_t **subscription, int *set_cnt, netconf_change_t *change) {
...
static void
cl_feature_dependencies_2_test_unregister_callbacks(sr_session_ctx_t *session, sr_subscription_ctx_t *subscription ) {
    int rc = SR_ERR_OK;
    rc = sr_unsubscribe(session, subscription);
    assert_int_equal(rc, SR_ERR_OK);
}
...
cl_feature_dependencies_2_test (void **state) {
    ...
    cl_feature_dependencies_2_test_register_callbacks(session, &subscription, &set_cnt, &change);
...
cleanup:
    ...
    cl_feature_dependencies_2_test_unregister_callbacks(session, subscription);
